use(["/libs/wcm/foundation/components/utils/AuthoringUtils.js",
    ...
    var image = {};
    console.log("AVATAR: " + this.avatarPath);
    granite.resource.resolve(this.avatarPath).then(function (imageResource) {
        if (imageResource.properties["fileReference"]) {
			image = new Image(imageResource);
            imageDeferred.resolve(image);
        } else {
            granite.resource.resolve(this.avatarPath + "/file").then(function (localImage) {
